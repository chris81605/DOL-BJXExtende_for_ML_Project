...
var colors = {
  ...
  "aliceblue": ["#F0F8FF", "hue-rotate(208deg) brightness(260%) saturate(20%) contrast(100%)", "浅蓝色"],
  "antiquewhite": ["#FAEBD7", "hue-rotate(4deg) brightness(230%) saturate(20%) contrast(120%)", "米白色"],
  ...
  "omendarkblue": ["#00008B", "hue-rotate(207deg) brightness(80%) saturate(79%) contrast(300%)","暗蓝色"],
  ...
  "darkturquoise": ["#00CED1", "hue-rotate(128deg) brightness(110%) saturate(249%) contrast(190%)", "深粉蓝"],
  "deepskyblue": ["#00BFFF", "hue-rotate(140deg) brightness(110%) saturate(249%) contrast(190%)", "深天蓝"],
  "omengreen": ["#008000", "hue-rotate(55deg) brightness(100%) saturate(69%) contrast(100%)", "绿色"],
  "lime": ["#00FF00", "hue-rotate(117deg) brightness(170%) saturate(120%) contrast(110%)", "浅黄绿"],
  "mediumblue": ["#0000CD", "hue-rotate(207deg) brightness(80%) saturate(179%) contrast(300%)", "中蓝色"],
  "mediumspringgreen": ["#00FA9A", "hue-rotate(117deg) brightness(170%) saturate(100%) contrast(140%)", "中草绿"],
  "navy": ["#000080", "hue-rotate(207deg) brightness(80%) saturate(79%) contrast(300%)", "深蓝色"],
  "navyblue": ["#16168d", "hue-rotate(206deg) brightness(100%) saturate(79%) contrast(300%)", "海军蓝"],
  "springgreen": ["#00FF7F", "hue-rotate(117deg) brightness(175%) saturate(120%) contrast(110%)", "草绿色"],
  "teal": ["#008080", "hue-rotate(128deg) brightness(90%) saturate(249%) contrast(190%)", "鸭绿色"],
  "midnightblue": ["#191970", "hue-rotate(206deg) brightness(80%) saturate(79%) contrast(300%)", "蓝黑色"],
  "dodgerblue": ["#1E90FF", "hue-rotate(140deg) brightness(107%) saturate(229%) contrast(190%)", "宝蓝色"],
  "lightseagreen": ["#20B2AA", "hue-rotate(124deg) brightness(107%) saturate(229%) contrast(190%)", "浅海绿"],
  ...
  "darkslategrey": ["#2F4F4F", "hue-rotate(156deg) brightness(90%) saturate(139%) contrast(300%)", "暗岩灰"],
  "mediumlimegreen": ["#32CD32", "hue-rotate(124deg) brightness(112%) saturate(269%) contrast(190%)", "中柠檬绿"],
  "mediumseagreen": ["#3CB371", "hue-rotate(124deg) brightness(112%) saturate(269%) contrast(190%)", "中海绿"],
  "turquoise": ["#40E0D0", "hue-rotate(131deg) brightness(122%) saturate(269%) contrast(160%)", "绿松石"],
  "royalblue": ["#4169E1", "hue-rotate(140deg) brightness(90%) saturate(229%) contrast(190%)", "皇家蓝"],
  "steelblue": ["#4682B4", "hue-rotate(140deg) brightness(100%) saturate(210%) contrast(200%)", "灰蓝色"],
  "darkslateblue": ["#483D8B", "hue-rotate(207deg) brightness(90%) saturate(120%) contrast(200%)", "暗青蓝"],
  "mediumturquoise": ["#48D1CC", "hue-rotate(131deg) brightness(128%) saturate(200%) contrast(270%)", "中绿松石"],
  ...
  "cornflowerblue": ["#6495ED", "hue-rotate(182deg) brightness(130%) saturate(109%) contrast(100%)", "矢车菊蓝"],
  "mediumaquamarine": ["#66CDAA", "hue-rotate(117deg) brightness(150%) saturate(100%) contrast(110%)", "中碧蓝"],
  ...
  "olivedrab": ["#6B8E23", "hue-rotate(25deg) brightness(108%) saturate(109%) contrast(120%)", "灰橄榄"],
  ...
  "lawngreen": ["#7CFC00", "hue-rotate(56deg) saturate(160%) brightness(150%) contrast(200%)", "草坪绿"],
  ...
  "olive": ["#808000", "hue-rotate(17deg) brightness(110%) saturate(120%) contrast(127%)", "橄榄绿"],
  "omenpurple": ["#800080", "hue-rotate(230deg) brightness(95%) saturate(70%) contrast(127%)", "紫色"],
  "lightskyblue": ["#87CEFA", "hue-rotate(143deg) brightness(172%) saturate(39%) contrast(220%)", "浅天蓝"],
  "skyblue": ["#87CEEB", "hue-rotate(143deg) brightness(182%) saturate(29%) contrast(200%)", "天蓝色"],
  "blueviolet": ["#8A2BE2", "hue-rotate(230deg) brightness(100%) saturate(140%) contrast(207%)", "蓝紫色"],
  "darkmagenta": ["#8B008B", "hue-rotate(230deg) brightness(100%) saturate(100%) contrast(207%)", "深品色"],
  "darkred": ["#8B0000", "hue-rotate(279deg) brightness(100%) saturate(70%) contrast(207%)", "深红色"],
  "saddlebrown": ["#8B4513", "hue-rotate(342deg) brightness(100%) saturate(70%) contrast(207%)", "鞍褐色"],
  "darkseagreen": ["#8FBC8F", "hue-rotate(46deg) saturate(80%) brightness(160%) contrast(140%)", "暗海绿"],
  "omenlightgreen": ["#90EE90", "hue-rotate(85deg) brightness(181%) saturate(40%) contrast(170%)", "浅绿色"],
  "mediumpurple": ["#9370DB", "hue-rotate(230deg) brightness(125%) saturate(70%) contrast(127%)", "中紫红"],
  "darkviolet": ["#9400D3", "hue-rotate(245deg) brightness(90%) saturate(90%) contrast(137%)", "暗紫罗兰"],
  "palegreen": ["#98FB98", "hue-rotate(85deg) brightness(184%) saturate(40%) contrast(170%)", "淡绿色"],
  "darkorchid": ["#9932CC", "hue-rotate(245deg) brightness(99%) saturate(90%) contrast(137%)", "暗紫蓝"],
  ...
  "mediumorchid": ["#BA55D3", "hue-rotate(242deg) brightness(121%) saturate(80%) contrast(157%)", "紫蓝色"],
  ...
  "indianred": ["#CD5C5C", "hue-rotate(349deg) saturate(140%) brightness(110%) contrast(160%)", "栗红色"],
  "peru": ["#CD853F", "hue-rotate(6deg) brightness(131%) saturate(130%) contrast(157%)", "秘鲁橘"],
  ...
  "palevioletred": ["#DB7093", "hue-rotate(279deg) saturate(60%) brightness(135%) contrast(160%)", "淡紫红"],
  "crimson": ["#DC143C", "hue-rotate(312deg) saturate(130%) brightness(100%) contrast(160%)", "绯红色"],
  ...
  "darksalmon": ["#E9967A", "hue-rotate(352deg) saturate(130%) brightness(145%) contrast(100%)", "暗鲑红"],
  "palegoldenrod": ["#EEE8AA", "hue-rotate(17deg) brightness(200%) saturate(64%) contrast(150%)", "灰金菊"],
  "violet": ["#EE82EE", "hue-rotate(225deg) brightness(147%) saturate(130%) contrast(170%)", "紫罗兰"],
  ...
  "ivory": ["#FFFFF0", "hue-rotate(15deg) brightness(199%) saturate(14%) contrast(220%)", "象牙白"],
  ...
  "seashell": ["#FFF5EE", "hue-rotate(1deg) brightness(199%) saturate(5%) contrast(220%)", "贝壳白"],
  "snow": ["#FFFAFA", "hue-rotate(1deg) brightness(205%) saturate(0%) contrast(220%)", "雪白"],
