...
function initNeck() {
	setup.clothes.neck = [
...

		{
			index: 1,
			name: "collar",
			name_cap: "Collar",cn_name_cap: "项圈",
			variable: "collar",
			integrity: 400,
			integrity_max: 400,
			fabric_strength: 20,
...

		{
			index: 2,
			name: "bunny collar",
			name_cap: "Bunny collar",cn_name_cap: "兔兔项圈",
...

		{
			index: 3,
			name: "holy pendant",
			name_cap: "Holy pendant",cn_name_cap: "十字架",
...

		{
			index: 4,
			name: "dark pendant",
			name_cap: "Dark pendant",cn_name_cap: "暗黑吊坠",
...

		{
			index: 5,
			name: "stone pendant",
			name_cap: "Stone pendant",cn_name_cap: "石制十字架",
...

		{
			index: 6,
			name: "gold choker",
			name_cap: "Gold choker",cn_name_cap: "金项圈",
			variable: "goldchoker",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			...
			name_cap: "Cat bell collar",cn_name_cap: "猫铃项圈",
			variable: "cat",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 8,
			name: "cow bell",
			name_cap: "Cow bell",cn_name_cap: "牛铃",
			variable: "cow",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 9,
			name: "lace choker",
			name_cap: "Lace choker",cn_name_cap: "蕾丝项圈",
			variable: "lacechoker",
			integrity: 40,
			integrity_max: 40,
			fabric_strength: 20,
...

		{
			index: 10,
			name: "spiked collar",
			name_cap: "Spiked collar",cn_name_cap: "铆钉项圈",
			variable: "spiked",
			integrity: 40,
			integrity_max: 40,
			fabric_strength: 20,
...

		{
			index: 11,
			name: "heart choker",
			name_cap: "Heart choker",cn_name_cap: "心型颈饰",
...

		{
			index: 12,
			name: "ringed collar",
			name_cap: "Ringed collar",cn_name_cap: "有环项圈",
...

		{
			index: 13,
			name: "necktie",
			name_cap: "Necktie",cn_name_cap: "领带",
			variable: "tie",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 14,
			name: "suspenders",
			name_cap: "Suspenders",cn_name_cap: "吊带",
			variable: "suspenders",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 15,
			name: "cloth choker",
			name_cap: "Cloth choker",cn_name_cap: "布质项圈",
...

		{
			index: 17,
			name: "gold chain",
			name_cap: "Gold chain",cn_name_cap: "金链子",
			variable: "chaingold",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 500,
...

		{
			index: 18,
			name: "iron chain",
			name_cap: "Iron chain",cn_name_cap: "铁链子",
			variable: "chainiron",
			integrity: 100,
			integrity_max: 100,
...

		{
			index: 19,
			name: "holy stole",
			name_cap: "Holy stole",cn_name_cap: "圣带",
			variable: "holystole",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 100,
...

		{
			...
			name_cap: "Free use collar",cn_name_cap: "公用性奴项圈",
			variable: "freeuse",
			integrity: 400,
			integrity_max: 400,
			fabric_strength: 20,
...

		{
			...
			name_cap: "Collar with leash",cn_name_cap: "带有栓绳的项圈",
...

		{
			...
			name_cap: "Free use collar with leash",cn_name_cap: "带有栓绳的公用性奴项圈",
...

		{
			index: 23,
			name: "ivory necklace",
			name_cap: "Ivory necklace",cn_name_cap: "象牙项链",
			...
			warmth: 0,
			cost: 200000,
			description: "一件圣物，曾经被一个古老教团的高级成员佩戴。你可以在宝石中看到你的倒影……你看起来很苍白。",
			shop: [],
			collared: 0,
			accessory: 0,
			accessory_colour: 0,
...

		{
			...
			name_cap: "Leather collar with leash",cn_name_cap: "带有栓绳的皮质项圈",
			...
			warmth: 0,
			cost: 24000,
			description: "需要特殊的工具才能解锁，但你拥有其钥匙。",
			shop: ["adult"],
			collared: 1,
			accessory: 1,
			accessory_colour: 0,
...

		{
			index: 25,
			name: "leather collar",
			name_cap: "Leather Collar",cn_name_cap: "皮质项圈",
...

		{
			...
			name_cap: "Spiked collar with leash",cn_name_cap: "带有栓绳的铆钉项圈",
...

		{
			index: 27,
			name: "short tie",
			name_cap: "Short tie",cn_name_cap: "短领带",
			variable: "shorttie",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 28,
			name: "fur boa",
			name_cap: "Fur boa",cn_name_cap: "毛绒围巾",
			variable: "boa",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 29,
			name: "sailor ribbon",
			name_cap: "Sailor ribbon",cn_name_cap: "水手丝带",
...

		{
			index: 30,
			name: "love locket",
			name_cap: "Love locket",cn_name_cap: "同心吊坠",
			variable: "lovelocket",
			integrity: 40,
			integrity_max: 40,
			fabric_strength: 20,
			...
			warmth: 0,
			cost: 3500,
			description: "打开后可以放置照片。可以在镜子前进行设置。",
			shop: ["clothing"],
			collared: 0,
			accessory: 0,
			accessory_colour: 0,
		...
		},
		{
			...
			name_cap: "Classic lace choker",cn_name_cap: "经典蕾丝项圈",
		...
		},
		{
			index: 32,
			name: "bowtie",
			name_cap: "Bowtie",cn_name_cap: "领结",
			variable: "bowtie",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
		...
		},
		{
			index: 33,
			name: "ribbon tie",
			name_cap: "Ribbon tie",cn_name_cap: "蝶形领带",
			variable: "ribbontie",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
