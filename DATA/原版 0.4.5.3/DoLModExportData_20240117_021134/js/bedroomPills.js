...
setup.pills = [
	{
		name: "bottom reduction",cn_name: "臀部缩减剂",
		description:
			"每片中含有500mg的普莱贝洛 (Praberrhol)，这种衍生分子专门设计用于与臀部的甘油三酯结合，并逐渐溶解它们。",
	...
	},
	{
		...
		description:
			"这种药片中含有九唐洛特洛星 (Nynthroptechloxin) 分子，由天才制药科学家班塞尔博士发明创造。它能增加体内负责臀部和髋部生长的特定激素的产生。每片中含有190mg有效剂量。",
		onTakeMessage: "你服下药片，希望能促进屁股的生长。但愿它如同广告上说的那样有效。",
		warning_label:
			"警告: 过量服用会产生严重的副作用。详情请咨询本地医生。不可与其他激素类药物同时服用。",
		autoTake() {
			return V.sexStats.pills["pills"][this.name].autoTake;
		},
		doseTaken() {
	...
	},
	{
		...
		description:
			"这种药片中含有普莱贝洛-NG2 (Praberrhol-NG2)，这种衍生分子专门设计用于与甘油三酯结合，并逐渐溶解它们。非活性成分三卡纳 (Trinelca) 可吸附在臀部的皮下脂肪组织上。每日摄入200mg以在获得脂肪和溶解脂肪之间取得平衡。",
	...
	{
		name: "breast reduction",cn_name: "乳房缩减剂",
		description:
	...
	},
	{
		...
		description:
			"一种选择性雌激素受体调节剂 (SERM)，能够阻断负责乳房生长的蛋白质受体；辅助剂为269mg的四唑丽诺斯地 (Tetraozealpostigyl)。",
	...
	{
		name: "penis reduction",cn_name: "阴茎缩减剂",
		description:
	...
	},
	{
		...
		description:
			"每颗药丸含有50毫克枸橼酸氯米芬，结构类似于雌激素，它也作用于你的下丘脑，使其分泌触发排卵所需的激素。在某些情况下，有效诱导你的卵巢释放卵子。",
		onTakeMessage: "你服下药片，希望能提高你的生育能力。但愿它如同广告上说的那样有效。",
		warning_label:
			"警告: 正常用法用量下可能会出现轻微的不良反应，包括类似早孕迹象的副作用。若服用超过每日最高限定剂量，可能会出现严重的并发症。如有疑问，请咨询您的医生。",
		autoTake() {
			return V.sexStats.pills["pills"][this.name].autoTake;
		},
		doseTaken() {
	...
	},
	{
		...
		onTakeMessage: "你服下了避孕药。但愿它如同广告上说的那样有效。",
		warning_label:
	...
	{
		name: "Anti-Parasite Cream",cn_name: "抗寄生物药膏",
		description:
			"一种含有氯菊酯的驱虫药膏。当使用时，它可以防止新的寄生虫感染发生，但对已发生寄生虫感染没有影响。使用后14天内有效。",
		onTakeMessage: "你将药膏涂抹在生殖器周围，希望这能避免被寄生与感染。",
		warning_label:
	...
	{
		name: "asylum's prescription",cn_name: "精神病院的处方药",
		description: "一种强而有力的抗精神病药物。",
		onTakeMessage: "你服用了精神病院开出的药丸。你感到有点晕眩。",
		warning_label:
			"<span class='hpi_notice_label'>提示: 这种药物在实验阶段没有确定的副作用，并且它通过了所有安全规定。<span class='hpi_blur unselectable'>我感觉这家药厂要把我害死了。没有副作用？扯啥淡呢？！</span></span>",
	...
	{
		name: "Dr Harper's prescription",cn_name: "哈珀医生的处方药",
		description: "抗精神病药物。",
	...
	{
		name: "Hair Growth Formula",cn_name: "生发配方",
		description:
			"这是一种含有米诺地尔和其他成分的喷雾剂，当直接喷洒在头发上时，能促进头发的快速生长并促进头发的健康。使用后3天内有效。",
		onTakeMessage: "你使用了喷雾，你希望它能帮助你的头发快速生长。",
		warning_label:
			"警告: 如果在使用后不久出现过敏反应，请咨询医生。如果您的嘴巴或眼睛接触到了喷雾，请立即联系医生。",
		autoTake() {
			return V.sexStats.pills["pills"][this.name].autoTake;
		},
		doseTaken() {
		...
		hpi_take_every_morning() {
			return this.autoTake() ? "停止使用" : "需要时启用";
		},
		type: "hair",
