...
setup.debugMenu.eventList = {
	...
	Character: [
		...
		{
			link: [`意识上升`, stayOnPassageFn],
			widgets: [`<<set $awareness += 200>>`],
		},
		{
			link: [`意识下降`, stayOnPassageFn],
			widgets: [`<<set $awareness -= 200>>`],
		},
		{
		...
		{
			link: [`胸部寄生物`, stayOnPassageFn],
			widgets: [`<<parasite nipples urchin>>`],
		},
		{
			link: [`阴茎寄生物`, stayOnPassageFn],
			widgets: [`<<parasite penis urchin>>`],
		},
		{
			link: [`贞操锁寄生物`, stayOnPassageFn],
		...
		{
			link: [`降低惠特尼支配`, stayOnPassageFn],
			widgets: [`<<npcincr Whitney dom -20>>`],
		},
		{
			link: [`提升惠特尼支配`, stayOnPassageFn],
			widgets: [`<<npcincr Whitney dom 20>>`],
		},
		{
