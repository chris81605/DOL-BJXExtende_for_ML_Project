...
function initFace() {
	setup.clothes.face = [
		...
		},
		{
			index: 1,
			name: "glasses",
			name_cap: "Glasses",cn_name_cap: "眼镜",
			variable: "glasses",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
			...
			warmth: 0,
			cost: 5000,
			description: "使你的学习更加轻松，但也增加了你在学校被欺负的风险。",
		...
		},
		{
			index: 2,
			name: "cool shades",
			name_cap: "Cool shades",cn_name_cap: "飒爽墨镜",
			variable: "coolshades",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 3,
			name: "surgical mask",
			name_cap: "Surgical mask",cn_name_cap: "医用外科口罩",
		...
		},
		{
			index: 5,
			name: "blindfold",
			name_cap: "Blindfold",cn_name_cap: "眼罩",
			variable: "blindfold",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			...
			name_cap: "Gag and blindfold",cn_name_cap: "口球和眼罩",
		...
		},
		{
			...
			name_cap: "Skulduggery mask",cn_name_cap: "窃贼面具",
			variable: "skulmask",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			...
			name_cap: "Low frame glasses",cn_name_cap: "低框眼镜",
			variable: "lowframe",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			...
			name_cap: "Half moon glasses",cn_name_cap: "半月形眼镜",
			variable: "halfmoon",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			...
			name_cap: "Deep frame glasses",cn_name_cap: "深框眼镜",
			variable: "deepframe",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 11,
			name: "square shades",
			name_cap: "Square shades",cn_name_cap: "方形墨镜",
			variable: "square",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 12,
			name: "round shades",
			name_cap: "Round shades",cn_name_cap: "圆形墨镜",
			variable: "round",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 13,
			name: "shield shades",
			name_cap: "Shield shades",cn_name_cap: "连体墨镜",
			variable: "shield",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 14,
			name: "cat eye shades",
			name_cap: "Cat eye shades",cn_name_cap: "猫眼墨镜",
			variable: "cateye",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 15,
			name: "aviators",
			name_cap: "Aviators",cn_name_cap: "飞行员眼镜",
			variable: "aviator",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 16,
			name: "punk shades",
			name_cap: "Punk shades",cn_name_cap: "朋克墨镜",
			variable: "punk",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 17,
			name: "muzzle",
			name_cap: "Muzzle",cn_name_cap: "嘴套",
			variable: "muzzle",
			integrity: 30,
			integrity_max: 30,
			fabric_strength: 20,
		...
		},
		{
			index: 18,
			name: "mummy facewrap",
			name_cap: "Mummy facewrap",cn_name_cap: "木乃伊裹脸布",
			variable: "mummy",
			integrity: 10,
			integrity_max: 10,
			fabric_strength: 1,
		...
		},
		{
			...
			name_cap: "Swimming goggles",cn_name_cap: "泳镜",
		...
		},
		{
			...
			name_cap: "Belly dancer's veil",cn_name_cap: "肚皮舞面纱",
			variable: "belly",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 23,
			name: "bit gag",
			name_cap: "Bit gag",cn_name_cap: "嚼子",
			variable: "bitgag",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 24,
			name: "wolf muzzle",
			name_cap: "Wolf muzzle",cn_name_cap:"狼用口套",
			variable: "wolfmuzzle",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 25,
			name: "kitty muzzle",
			name_cap: "Kitty muzzle",cn_name_cap:"猫用口套",
		...
		},
		{
			index: 26,
			name: "cloth gag",
			name_cap: "Cloth gag",cn_name_cap:"塞入嘴里的衣物",
			variable: "clothgag",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 27,
			name: "panty gag",
			name_cap: "Panty gag",cn_name_cap:"塞嘴内裤",
			variable: "pantygag",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 28,
			name: "tape gag",
			name_cap: "Tape gag",cn_name_cap:"封口胶带",
			variable: "tapegag",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 29,
			name: "penis gag",
			name_cap: "Penis gag",cn_name_cap:"肉棒口球",
			variable: "penisgag",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 30,
			name: "skeleton mask",
			name_cap: "Skeleton mask",cn_name_cap:"骷髅面具",
			variable: "skele",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			...
			name_cap: "Esoteric spectacles",cn_name_cap:"行家眼镜",
			variable: "esoteric",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
			...
			warmth: 0,
			cost: 50000,
			description:"哈草大师专用眼镜，是草在哈我，是草在哈我！",
			shop: ["forest"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
		...
		},
		{
			index: 32,
			name: "gas mask",
			name_cap: "Gas mask",cn_name_cap: "防毒面具",
			variable: "gasmask",
			integrity: 300,
			integrity_max: 300,
			fabric_strength: 25,
		...
		},
		{
			index: 33,
			name: "eyepatch",
			name_cap: "Eyepatch",cn_name_cap: "眼罩",
			variable: "eyepatch",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			...
			name_cap: "Medical eyepatch",cn_name_cap: "医用眼罩",
		...
		},
		{
			index: 35,
			name: "doggy muzzle",
			name_cap: "Doggy Muzzle",cn_name_cap: "犬用嘴套",
...

		{
			index: 36,
			name: "bamboo muzzle",
			name_cap: "Bamboo muzzle",cn_name_cap: "竹制嘴套",
		...
		},
		{
			index: 37,
			name: "monocle",
			name_cap: "Monocle",cn_name_cap: "单片眼镜",
			variable: "monocle",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
		...
		},
		{
			index: 38,
			name: "islander mask",
			name_cap: "Islander mask",cn_name_cap: "岛民面具",
		...
		},
		{
			...
			name_cap: "Reading glasses", cn_name_cap: "阅读眼镜",
			variable: "reading",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
