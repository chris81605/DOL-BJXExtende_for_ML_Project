...
function initFeet() {
	setup.clothes.feet = [
		...
		},
		{
			index: 1,
			name: "school shoes",
			name_cap: "School shoes",cn_name_cap: "校服鞋",
...

		{
			index: 2,
			name: "tuxedo shoes",
			name_cap: "Tuxedo shoes",cn_name_cap: "正装皮鞋",
...

		{
			index: 3,
			name: "ankle cuffs",
			name_cap: "Ankle cuffs",cn_name_cap: "脚镣",
			variable: "anklecuffs",
			integrity: 400,
			integrity_max: 400,
			fabric_strength: 20,
...

		{
			index: 4,
			name: "sandals",
			name_cap: "Sandals",cn_name_cap: "凉鞋",
			variable: "sandals",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 5,
			name: "dress sandals",
			name_cap: "Dress sandals",cn_name_cap: "高跟凉鞋",
...

		{
			index: 6,
			name: "trainers",
			name_cap: "Trainers",cn_name_cap: "运动鞋",
			variable: "trainers",
			integrity: 250,
			integrity_max: 250,
			fabric_strength: 20,
...

		{
			index: 7,
			name: "witch shoes",
			name_cap: "Witch shoes",cn_name_cap: "女巫鞋",
			variable: "witch",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 20,
...

		{
			index: 8,
			name: "wellies",
			name_cap: "Wellies",cn_name_cap: "长筒雨靴",
			variable: "wellies",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 20,
...

		{
			index: 9,
			name: "platform heels",
			name_cap: "Platform heels",cn_name_cap: "舞台高跟鞋",
...

		{
			index: 10,
			name: "kitten heels",
			name_cap: "Kitten heels",cn_name_cap: "小巧高跟鞋",
...

		{
			index: 11,
			name: "wedge sandals",
			name_cap: "Wedge sandals",cn_name_cap: "坡跟凉鞋",
...

		{
			index: 12,
			name: "court heels",
			name_cap: "Court heels",cn_name_cap: "宫廷高跟鞋",
			variable: "courtheels",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 20,
...

		{
			index: 13,
			name: "heeled boots",
			name_cap: "Heeled boots",cn_name_cap: "高跟靴",
			variable: "bootheels",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 20,
...

		{
			index: 14,
			name: "stripper heels",
			name_cap: "Stripper heels",cn_name_cap: "脱衣舞娘高跟鞋",
...

		{
			...
			name_cap: "Horsebit loafers",cn_name_cap: "马衔扣便鞋",
...

		{
			...
			name_cap: "Cordovan loafers",cn_name_cap: "马皮乐福鞋",
			...
			warmth: 10,
			cost: 40000,
			description: "一双马臀皮做成的平底皮鞋。相当昂贵，但物有所值。",
			shop: ["clothing"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			index: 17,
			name: "bunny slippers",
			name_cap: "Bunny slippers",cn_name_cap: "兔兔拖鞋",
			variable: "bunny",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 18,
			name: "combat boots",
			name_cap: "Combat boots",cn_name_cap: "军靴",
			variable: "combat",
			integrity: 500,
			integrity_max: 500,
			fabric_strength: 50,
...

		{
			index: 19,
			name: "field boots",
			name_cap: "Field boots",cn_name_cap: "马靴",
			variable: "field",
			integrity: 400,
			integrity_max: 400,
			fabric_strength: 40,
...

		{
			index: 20,
			name: "paddock boots",
			name_cap: "Paddock boots",cn_name_cap: "短马靴",
			variable: "paddock",
			integrity: 300,
			integrity_max: 300,
			fabric_strength: 40,
...

		{
			index: 21,
			name: "work boots",
			name_cap: "Work boots",cn_name_cap: "工作靴",
			variable: "work",
			integrity: 300,
			integrity_max: 300,
			fabric_strength: 40,
...

		{
			index: 22,
			name: "flippers",
			name_cap: "Flippers",cn_name_cap: "蛙蹼",
			variable: "flippers",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 60,
...

		{
			index: 23,
			name: "ice skates",
			name_cap: "Ice skates",cn_name_cap: "溜冰鞋",
			variable: "iceskates",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
...

		{
			index: 24,
			name: "long boots",
			name_cap: "Long boots",cn_name_cap: "长靴",
			variable: "long",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 60,
...

		{
			...
			name_cap: "Light-up trainers",cn_name_cap: "发光运动鞋",
...

		{
			index: 26,
			name: "ball and chain",
			name_cap: "Ball and chain",cn_name_cap: "铁球和锁链",
			variable: "ballchain",
			integrity: 400,
			integrity_max: 400,
			fabric_strength: 20,
...

		{
			index: 27,
			name: "cowboy boots",
			name_cap: "Cowboy boots",cn_name_cap: "牛仔靴",
			variable: "cowboy",
			integrity: 350,
			integrity_max: 350,
			fabric_strength: 40,
...

		{
			...
			name_cap: "High top trainers",cn_name_cap: "高帮运动鞋",
			variable: "hightops",
			integrity: 300,
			integrity_max: 300,
			fabric_strength: 20,
...

		{
			...
			name_cap: "Belly dancer's shoes",cn_name_cap: "肚皮舞鞋",
			variable: "belly",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 20,
...

		{
			index: 30,
			name: "canvas loafers",
			name_cap: "Cordovan loafers",cn_name_cap: "帆布乐福鞋",
		...
		},
		{
			...
			name_cap: "Thigh-high heeled boots",cn_name_cap: "高筒靴",
		...
		},
		{
			index: 32,
			name: "fur boots",
			name_cap: "Fur boots",cn_name_cap: "兽皮靴",
			variable: "fur_boots",
			integrity: 200,
			integrity_max: 200,
			fabric_strength: 20,
