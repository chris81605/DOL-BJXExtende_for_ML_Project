...
function bodySizeCalc(bodysize) {
	switch (bodysize) {
		case 0:
			return ["偏小", "偏小", "偏小", "较小", "较小", "正常", "较大"][random(0, 6)];
		case 1:
			return ["偏小", "偏小", "较小", "较小", "较小", "正常", "正常", "较大"][random(0, 7)];
		case 2:
			return ["偏小", "较小", "较小", "正常", "正常", "正常", "较大", "较大"][random(0, 7)];
		case 3:
			return ["偏小", "较小", "正常", "正常", "较大", "较大", "较大"][random(0, 6)];
		default:
			return ["偏小", "较小", "正常", "较大"][random(0, 3)];
	}
}
