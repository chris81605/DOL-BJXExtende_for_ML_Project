...
function initUnderLower() {
	setup.clothes.under_lower = [
...

		{
			index: 1,
			name: "plain panties",
			name_cap: "Plain panties",cn_name_cap: "普通内裤",
			name_simple: "panties",
...

		{
			index: 2,
			name: "bikini bottoms",
			name_cap: "Bikini bottoms",cn_name_cap:"比基尼下装",
...

		{
			index: 3,
			name: "lace panties",
			name_cap: "Lace panties",cn_name_cap:"蕾丝内裤",
			name_simple: "panties",
...

		{
			index: 4,
			name: "briefs",
			name_cap: "Briefs",cn_name_cap:"紧身内裤",
			name_simple: "undies",
			variable: "briefs",
			integrity: 100,
			integrity_max: 100,
...

		{
			index: 5,
			name: "chastity belt",
			name_cap: "Chastity belt",cn_name_cap: "贞操带",
...

		{
			...
			name_cap: "School swimsuit bottom",cn_name_cap:"学校泳装下部",
...

		{
			...
			name_cap: "School swim shorts",cn_name_cap:"学校泳裤",
...

		{
			index: 8,
			name: "leotard bottom",
			name_cap: "Leotard bottom",cn_name_cap:"紧身衣下部",
			name_simple: "leotard",
			variable: "leotard",
			integrity: 100,
			integrity_max: 100,
...

		{
			index: 9,
			name: "unitard bottom",
			name_cap: "Unitard bottom",cn_name_cap:"连体紧身衣下部",
			name_simple: "leotard",
			variable: "unitard",
...

		{
			...
			name_cap: "Skimpy leotard bottom",cn_name_cap:"轻薄紧身衣下部",
			name_simple: "leotard",
...

		{
			...
			name_cap: "Foreign school swimsuit bottom",cn_name_cap:"异域学校泳装下部",
			name_simple: "swimsuit",
			...
			warmth: 5,
			cost: 0,
			description: "本地学校承认的官方泳装，但是这种款式在外国学校很流行。",
			shop: ["clothing", "school"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			...
			name_cap: "Swimsuit bottom",cn_name_cap:"泳装下部",
			name_simple: "swimsuit",
			variable: "swimsuit",
			integrity: 60,
			integrity_max: 60,
...

		{
			...
			name_cap: "Bunny leotard bottom",cn_name_cap:"紧身兔女郎装下部",
			name_simple: "leotard",
			...
			warmth: 5,
			cost: 0,
			description: "服务员制服。比它看上去还要结实。从背后白色的小尾巴可以看出来这是兔女郎套装的一部分。",
			shop: ["adult"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			index: 14,
			name: "boyshorts",
			name_cap: "Boyshorts",cn_name_cap:"平角裤",
			name_simple: "undies",
			variable: "boyshorts",
			integrity: 120,
			integrity_max: 120,
...

		{
			...
			name_cap: "Catgirl panties",cn_name_cap:"猫女内裤",
			name_simple: "panties",
...

		{
			index: 16,
			name: "G-string",
			name_cap: "G-string",cn_name_cap:"系带丁字裤",
...

		{
			...
			name_cap: "Crotchless panties",cn_name_cap:"开裆内裤",
			name_simple: "panties",
...

		{
			...
			name_cap: "Microkini bottom",cn_name_cap:"微型比基尼下装",
			name_simple: "swimsuit",
			variable: "microkini",
			integrity: 30,
			integrity_max: 30,
...

		{
			index: 19,
			name: "speedo",
			name_cap: "Speedo",cn_name_cap:"速干泳裤",
			name_simple: "speedo",
			variable: "speedo",
			integrity: 50,
			integrity_max: 50,
...

		{
			...
			name_cap: "Striped panties",cn_name_cap:"条纹内裤",
			name_simple: "panties",
...

		{
			index: 21,
			name: "loincloth",
			name_cap: "Loincloth",cn_name_cap:"腰布",
			...
			warmth: 10,
			cost: 100,
			description: "暴露、毫无保护作用、耐用、原始人风情。",
			shop: ["forest"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			index: 22,
			name: "thong",
			name_cap: "Thong",cn_name_cap: "丁字裤",
			name_simple: "thong",
			variable: "thong",
			integrity: 40,
			integrity_max: 40,
...

		{
			...
			name_cap: "Classic plain panties",cn_name_cap: "经典款普通内裤",
			name_simple: "panties",
...

		{
			...
			name_cap: "Classic bikini bottoms",cn_name_cap: "经典款比基尼下装",
			name_simple: "bikini bottoms",
...

		{
			...
			name_cap: "Classic lace panties",cn_name_cap: "经典款蕾丝内裤",
			name_simple: "panties",
...

		{
			index: 26,
			name: "classic briefs",
			name_cap: "Classic briefs",cn_name_cap:"经典款紧身内裤",
			name_simple: "undies",
...

		{
			...
			name_cap: "Classic school swimsuit bottom",cn_name_cap: "经典款校服泳装下部",
			name_simple: "swimsuit",
...

		{
			index: 28,
			name: "jockstrap",
			name_cap: "Jockstrap",cn_name_cap: "紧身护裆",
...

		{
			index: 29,
			name: "boxers",
			name_cap: "Boxers",cn_name_cap: "四角裤",
			name_simple: "undies",
			variable: "boxers",
			integrity: 100,
			integrity_max: 100,
...

		{
			index: 30,
			name: "long johns",
			name_cap: "Long johns",cn_name_cap: "秋裤",
...

		{
			...
			name_cap: "School swim bottoms",cn_name_cap: "学校泳裤",
			...
			femininity: 300,
			cost: 3000,
			description: "作为被许可使用的学生制服，其暴露程度令人意外。",
			shop: ["clothing", "school"],
			accessory: 0,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			index: 32,
			name: "cow panties",
			name_cap: "Cow panties",cn_name_cap: "奶牛内裤",
			name_simple: "panties",
			variable: "cow",
			integrity: 100,
			integrity_max: 100,
...

		{
			index: 33,
			name: "strap-on",
			name_cap: "Strap-on",cn_name_cap: "穿戴式假阳具",
...

		{
			...
			name_cap: "Strap-on horse cock",cn_name_cap: "穿戴式马阳具",
			name_simple: "strap-on",
			...
			warmth: 0,
			cost: 8000,
			description: "造型奇特的马屌。穿戴在臀部，用于插入式性爱。",
			shop: [],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			...
			name_cap: "Strap-on knotted cock",cn_name_cap: "有锁结的穿戴式假阳具",
			name_simple: "strap-on",
			...
			warmth: 0,
			cost: 8000,
			description: "造型奇特的狗屌。穿戴在臀部，用于插入式性爱。",
			shop: [],
			accessory: 1,
			accessory_colour: 0,
			accessory_colour_options: [],
...

		{
			...
			name_cap: "Strap-on studded cock",cn_name_cap: "穿戴式带钉假阳具",
			name_simple: "strap-on",
...

		{
			...
			name_cap: "Shibari ropes bottom",cn_name_cap: "缚绳下装",
...

		{
			...
			name_cap: "Microkini bottom",cn_name_cap:"高腰微型比基尼下装",
			name_simple: "swimsuit",
...

		{
			...
			name_cap: "Turtleneck leotard",cn_name_cap: "高领紧身衣下部",
			name_simple: "leotard",
...

		{
			...
			name_cap: "Tie side bikini bottoms",cn_name_cap:"系带比基尼下装",
			name_simple: "bikini bottoms",
...

		{
			...
			name_cap: "Vintage lace panties",cn_name_cap:"复古蕾丝内裤",
			name_simple: "panties",
